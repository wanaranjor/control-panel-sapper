<script>
	...
	import SignOutButtom from '../SignOutButtom.svelte';
	import { goto } from '@sapper/app';
</script>

<nav id="header" class="bg-white fixed w-full z-10 top-0 shadow">
	<div class="flex flex-wrap items-center mt-0 pt-3 pb-3 px-4 py-3 md:pb-0">
		<div class="w-1/2 pl-2 md:pl-0">
			<a class="text-gray-900 text-base xl:text-xl no-underline hover:no-underline font-bold" href="/">
					<i class="fas fa-sun text-orange-600 pr-3"></i> Control Panel
			</a>
		</div>
			...
			<div class="flex relative inline-block float-right">
				<div class="relative text-sm">
					<button id="userButton" class="flex items-center focus:outline-none mr-3">
							...
							<span class="hidden md:inline-block">Hi, {$currentUser.email}</span>
					...
					<!-- TODO: pendiente arreglar menu toggle	en XS		 -->
		...
		<div id="nav-content" class="w-full flex-grow lg:flex lg:items-center lg:w-auto hidden lg:block mt-2 lg:mt-0 bg-white z-20">
			<ul class="list-reset lg:flex flex-1 items-center px-4 md:px-0">
				<li class="mr-6 my-2 md:my-0">
						<a href="/customers" class="block py-1 md:py-3 pl-1 align-middle text-orange-600 no-underline hover:text-gray-900 border-b-2 border-orange-600 hover:border-orange-600">
